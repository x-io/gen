...
func testRouteOK(method string, t *testing.T) {
	...
	passedAny := false
	r := New()
	r.Any("/test2", func(c core.Context) {
		passedAny = true
	})
	r.Handle(method, "/test", func(c core.Context) {
		passed = true
	})
...
func testRouteNotOK(method string, t *testing.T) {
	passed := false
	router := New()
	router.Handle(method, "/test_2", func(c core.Context) {
		passed = true
	})
...
func testRouteNotOK2(method string, t *testing.T) {
	...
	router.Handle(methodRoute, "/test", func(c core.Context) {
		passed = true
	})
...
func TestRouterMethod(t *testing.T) {
	router := New()
	router.Put("/hey2", func(c core.Context) {
		c.String(http.StatusOK, "sup2")
	})

	router.Put("/hey", func(c core.Context) {
		c.String(http.StatusOK, "called")
	})

	router.Put("/hey3", func(c core.Context) {
...
func TestRouteRedirectTrailingSlash(t *testing.T) {
	...
	router.GET("/path", func(c core.Context) {})
	router.GET("/path2/", func(c core.Context) {})
	router.POST("/path3", func(c core.Context) {})
	router.Put("/path4/", func(c core.Context) {})
...
func TestRouteRedirectFixedPath(t *testing.T) {
	...
	router.GET("/Path2", func(c core.Context) {})
	router.POST("/PATH3", func(c core.Context) {})
	router.POST("/Path4/", func(c core.Context) {})
...
func TestRouteParamsByName(t *testing.T) {
	...
	wild := ""
	router := New()
	router.GET("/test/:name/:last_name/*wild", func(c core.Context) {
...
func TestRouterMiddlewareAndStatic(t *testing.T) {
	router := New()
	static := router.Group("/", func(c core.Context) {
...
func TestRouteNotAllowedEnabled(t *testing.T) {
	router := New()
	router.HandleMethodNotAllowed = true
	router.POST("/path", func(c core.Context) {})
	w := performRequest(router, "GET", "/path")
	assert.Equal(t, http.StatusMethodNotAllowed, w.Code)

	router.NoMethod(func(c core.Context) {
...
func TestRouterNotFound(t *testing.T) {
	...
	router.RedirectFixedPath = true
	router.GET("/path", func(c core.Context) {})
	router.GET("/dir/", func(c core.Context) {})
	router.GET("/", func(c core.Context) {})
	...
	var notFound bool
	router.NoRoute(func(c core.Context) {
	...
	router.PATCH("/path", func(c core.Context) {})
	...
	router = New()
	router.GET("/a", func(c core.Context) {})
	w = performRequest(router, "GET", "/")
	assert.Equal(t, http.StatusNotFound, w.Code)
}
